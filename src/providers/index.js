...
export function createProviders() {
  ...
  const defs = [
    ['OPENAI_API_KEY', () => new OpenAIProvider({ apiKey: process.env.OPENAI_API_KEY, model: process.env.OPENAI_MODEL || 'gpt-5' })],
    ['ANTHROPIC_API_KEY', () => new AnthropicProvider({ apiKey: process.env.ANTHROPIC_API_KEY, model: process.env.ANTHROPIC_MODEL || 'claude-opus-5' })],
    ['GEMINI_API_KEY', () => new GeminiProvider({ apiKey: process.env.GEMINI_API_KEY, model: process.env.GEMINI_MODEL || 'gemini-3.7-flash' })],
    ['XAI_API_KEY', () => new XAIProvider({ apiKey: process.env.XAI_API_KEY, model: process.env.XAI_MODEL || 'grok-4.6' })]
  ];
